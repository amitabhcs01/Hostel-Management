...
<body>
	...
	<div class="ts-main-content login-page bk-img" style="background-image: url(img/SSPM.jpeg);">
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-6 col-md-offset-3" style="background-color: lightblue;">
						<div class="well row pt-2x pb-3x bk-light"  style="background-color: lightblue;">
