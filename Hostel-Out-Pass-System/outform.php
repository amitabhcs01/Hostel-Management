...
<head>
  ...
  <!--===============================================================================================-->	
	<link rel="icon" type="image/jpg" href="images/outform.jpg"/>
  <!--===============================================================================================-->
...
<section >
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top " style="background:#2196f3;">
	...
	<li>
         <a href="" style=" text-decoration: none;">&nbsp &nbsp &#127891; &nbsp <?PHP echo $_SESSION['student'];?></a>
    </li>
      <li class="nav-item  active">
        <a class="nav-link" href="outform.php">  &#128221;   Outing Form<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h2 class="text-center">Outing Form</h2>
          <form action="outformdata.php" role="form" method="POST">
